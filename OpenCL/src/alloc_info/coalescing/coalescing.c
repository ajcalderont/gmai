...
int main(int argc, char* argv[])
{
    ...
    // Coalescing support
	/*----------------------------------------------------------------------------------------*/
    cl_mem buf_1 = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_ALLOC_HOST_PTR, granularity, NULL, &ret);
    ...
    char *h_1 = (char*)clEnqueueMapBuffer(command_queue, buf_1, CL_TRUE, CL_MAP_READ | CL_MAP_WRITE, 0, granularity, 0, NULL, NULL, &ret);
    ...
    cl_mem buf_4 = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_ALLOC_HOST_PTR, granularity * 2, NULL, &ret);
    char *h_4 = (char*)clEnqueueMapBuffer(command_queue, buf_4, CL_TRUE, CL_MAP_READ | CL_MAP_WRITE, 0, granularity * 2, 0, NULL, NULL, &ret);
